...
class RewardsCfg:
    ...
    terminating = RewTerm(func=mdp.is_terminated_term, weight=-200.0)
    ...
    undesired_contacts = RewTerm(
        ...
        weight=-1.0,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=[".*hip_pitch_1",".*thigh_1",".*hip_yaw_1"]), "threshold": 1.0},
    )
    slide = RewTerm(
        func=mdp.feet_slide,
        weight=-0.8,
